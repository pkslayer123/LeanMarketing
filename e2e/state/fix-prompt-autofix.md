...
## Task: Fix a bug reported by quality testing (MOC build-dashboard_and_project_overview-1772555981549)
**Title:** Build feature: Dashboard and Project Overview
**Page:** /api/projects
**Source files:** app\api\projects\route.ts
**Change type:** bug_fix
