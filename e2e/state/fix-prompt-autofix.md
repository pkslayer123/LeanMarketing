...
## Task: Fix a bug reported by quality testing (MOC build-layer_2_audience_and_outreach-1772554513869)
**Title:** Build feature: Layer 2 — Audience and Outreach
**Page:** /api/leads
**Source files:** app\api\leads\route.ts
**Change type:** bug_fix
